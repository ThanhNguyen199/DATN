...
<head>
  ...
  <!-- Font Awesome Icons -->
  <link rel="stylesheet" href="{{asset('public/be/css/fontawesome/all.min.css')}}">
  <!-- IonIcons -->
            ...
            <div class="card">
              ...
              <div class="card-body table-responsive p-0">
                <table class="table table-striped table-valign-middle">
                  ...
                  <tr>
                    <td>
                      <img src="{{'public/be/dist/img/default-150x150.png'}}" alt="Product 1" class="img-circle img-size-32 mr-2">
                      Perfect Item
...
<script src="{{asset('public/be/dist/js/pages/dashboard3.js')}}"></script>
</body>
</html>
